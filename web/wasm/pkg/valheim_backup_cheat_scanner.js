    ...
    */
    add_tar(name, bytes) {
        try {
            ...
            wasm.browserscanner_add_tar(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
    ...
    */
    add_file(name, bytes) {
        try {
            ...
            const ptr1 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.browserscanner_add_file(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('valheim_backup_cheat_scanner_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
